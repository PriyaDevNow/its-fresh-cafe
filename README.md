...
----
You can view the live site here:- [It's Fresh!](https://8000-priyadevnow-itsfreshcaf-qjkvhx4a03t.ws-eu93.gitpod.io/)
...
* Authorised takeaway Staff can access all the features of the website and can read, create, edit, and delete the menu items.
...
The following Epics were created which were further developed into 21 User Stories. 

### Epic 1- Website UI
Epic Goals for Customer - 
* User personas were generated using [User Persona AI](https://userpersona.dev/) as detailed below
<details closed>
...
- CSS using [Jigsaw CSS validator](coderscafe/assets/images/jigsaw.w3.org_css-validator_validator.png)
- Python via [PEP8 CI Python Linter](https://pep8ci.herokuapp.com/) and the test results for Customer directory models.py and views.py files are here showing no code errors but spacing errors which will be fixed:
[PEP8 CI Python Linter - models.py](coderscafe/assets/images/pep8ci_models.py.png) 
[PEP8 CI Python Linter - views.py](coderscafe/assets/images/pep8ci_views.py.png)

#### Browser testing
I have tested that this website works as intended in browsers: 
- Chrome
- Edge
I will also test in Firefox.
...
Desktop view of Order page:
<img src="coderscafe/assets/images/Lighthouse_Desktop_Order page.JPG" alt="Order page">

Mobile view of Order page:
<img src="coderscafe/assets/images/LighthouseMobileOrderpage.JPG" alt="Order page">
...
| The images in the About page are not centred.  I tried to amend the code to permit this but did not have success. | 
...
- Fellow CI student [Jyoti Yadav](https://github.com/Code-Institute-Submissions/Blog_Website_PP4) for her Incredible India project whose Readme is the basis of this Readme.
...
- Youtube videos [The Dumbfounds](https://www.youtube.com/playlist?list=PLbpAWbHbi5rMF2j5n6imm0enrSD9eQUaM) for automated testing to be coded in the future.

## Content and Media
- The menu images are mine.  
- The rest of the images are taken from royalty free sites like [Unsplash](https://unsplash.com/) and [Pexels](https://www.pexels.com/).  
- Compression of images to help with performance was done using [Tiny PNG editor](https://tinypng.com/).

----

## Acknowledgement

Special thanks to my tutor Richey Malhotra and my fellow student Jack.  
